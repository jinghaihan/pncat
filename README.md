...
- **Setup** - Initialize configuration with optimized rules
...
You can use `pncat setup` to initialize a configuration file with optimized rules based on your current workspace, or create a `pncat.config.ts` file manually to customize catalog rules:
