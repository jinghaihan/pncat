...
import { resolveRemove } from '../../src/commands/remove'
import { COMMAND_ERROR_CODES, runAgentRemove } from '../../src/commands/shared'
...
function toWorkspaceManager(workspace: RemoveWorkspaceLike): WorkspaceManager {
